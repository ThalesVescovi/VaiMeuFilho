...
def main():
    arqHistSujeitos = open("C:\\Users\\thale\\PycharmProjects\\VaiMeuFilho\\bd_projeto\\att_faces_histogramas\\base_histogramas_cmct.txt", "w")
    arqHistSujeitosTeste = open("C:\\Users\\thale\\PycharmProjects\\VaiMeuFilho\\bd_projeto\\att_faces_histogramas\\teste_histogramas_cmct.txt", "w")
    print('--------- CMCT ---------')
