...
face_cascade = cv2.CascadeClassifier('"C:\\Users\\thale\\PycharmProjects\\VaiMeuFilho\\detection\\haarcascade_frontalface_alt.xml')
...
def main():
    junk=0
    valid=0
    path = ('C:\\Users\\thale\\PycharmProjects\\VaiMeuFilho\\bd_projeto\\att_faces\\s1')
    recp = ('C:\\Users\\thale\\PycharmProjects\\VaiMeuFilho\\bd_projeto\\att_faces\\s0')
    ...
    if not validcheck(path) and not validcheck(recp):
        ...
        for file in data:
            ...
            if ext=='.jpg' or ext =='.pgm' or ext == '.png':
