...
def main():
    arqHistSujeitos = open("C:\\Users\\thale\\PycharmProjects\\VaiMeuFilho\\bd_projeto\\att_faces_histogramas\\base_histogramas_cmct.txt", "r")
    arqHistTestes = open("C:\\Users\\thale\\PycharmProjects\\VaiMeuFilho\\bd_projeto\\att_faces_histogramas\\teste_histogramas_cmct.txt", "r")
    ...
    #CLASSIFICAÇÃO
    testeSet = np.array([lstArqHistTestes[3-1][2]], dtype=np.float32)  # Em Teste: Sujeito 3; face 8;
